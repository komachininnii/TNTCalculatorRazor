...
- ActualBmr：実測体重ベースのBMR
- CorrectedBmr：体重補正をおこなったBMR
- CorrectedBmrEnergyRawKcal：実数値
- CorrectedBmrEnergyDisplayKcal：丸め後の表示用
- EnergyOrderType の Enum は BMRベースの場合は CorrectedBmrBased とする。
