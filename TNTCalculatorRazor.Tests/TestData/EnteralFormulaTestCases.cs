...
public static class EnteralFormulaTestCases
{
    ...
    {
        yield return new object[] { EnteralFormulaType.Meibalance10, 400.0, 400.0 };
        yield return new object[] { EnteralFormulaType.PeptamenPrebio15, 400.0, 267.0 };
        yield return new object[] { EnteralFormulaType.PeptamenIntense10, 200.0, 200.0 };
        yield return new object[] { EnteralFormulaType.PeptamenAF15, 300.0, 200.0 };
        yield return new object[] { EnteralFormulaType.IsocalSupport15, 400.0, 267.0 };
