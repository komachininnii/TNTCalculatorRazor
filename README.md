...
<p>
  ...
  <a href="docs/img/screenshot-mobile.png">
    <img src="docs/img/screenshot-mobile.png" height="331" alt="Mobile screenshot">
  </a>
</p>

## 使い方
1. 年齢・身長・体重（必要に応じてCr）を入力  
2. 性別、疾患、活動度などを選択  
3. 必要エネルギー・蛋白・水分、推定CCrが自動表示されます  
4. 経腸栄養剤を選択すると、投与量や成分も自動算出されます  

※スクリーンショットに表示されている数値や商品名はダミーです。
